    ...
    public partial class Initial_001 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TicketAttachmentss", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TicketAttachmentss_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_TicketAttachmentss_Tickets_TicketId",
                        column: x => x.TicketId,
                        principalTable: "Tickets",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TicketAttachmentss_TicketId",
                table: "TicketAttachmentss",
                column: "TicketId");

            migrationBuilder.CreateIndex(
                name: "IX_TicketAttachmentss_UserId",
                table: "TicketAttachmentss",
                column: "UserId");
