...
namespace TheBugTracker.Controllers
{
    public class TicketAttachmentsController : Controller
    {
        ...
        {
            var applicationDbContext = _context.TicketAttachmentss.Include(t => t.Ticket).Include(t => t.User);
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            TicketAttachment ticketAttachment = await _context.TicketAttachmentss
                .Include(t => t.Ticket)
                .Include(t => t.User)
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            TicketAttachment ticketAttachment = await _context.TicketAttachmentss.FindAsync(id);
            if (ticketAttachment == null)
            {
                return NotFound();
            }
        ...
        {
            TicketAttachment ticketAttachment = await _context.TicketAttachmentss.FindAsync(id);
            _context.TicketAttachmentss.Remove(ticketAttachment);
            await _context.SaveChangesAsync();
            return RedirectToAction(nameof(Index));
        }
        ...
        {
            return _context.TicketAttachmentss.Any(e => e.Id == id);
        }
    }
}
